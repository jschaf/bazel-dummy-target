...
def go_repos():
    ...
    go_repository(
        ...
        sum = "h1:v0iUm/b4SBz7lR/diMoz9tLAz8lqtnNRKIwMrmU2HEU=",
        version = "v0.12.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:pMEjRZ1M4ebWGikflH7nQpV6+Zr88KBMA2XJD3sbijw=",
        version = "v0.20.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Yv3pKbXQqpdhrt53r+Yr1XveoqVgIFTCQdaamSalWwM=",
        version = "v0.0.0-20190424031103-cb2dda6eabdf",
    )
